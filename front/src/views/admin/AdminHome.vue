...
import AdminMovie from '@/components/admin/AdminMovie.vue'
...
import AdminCinema from '@/components/admin/AdminCinema.vue'
import AdminHall from '@/components/admin/AdminHall.vue'
...
const handleLogout = () => {
  // 清除管理员的 accessToken、refreshToken 和用户信息，确保完全登出
...
onMounted(() => {
  const adminStr = localStorage.getItem(TOKEN_KEYS.ADMIN)
  if (adminStr) {
