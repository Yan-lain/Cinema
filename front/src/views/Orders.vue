          ...
          if (scheduleData.success) {
            ...
            if (schedule) {
              ...
              if (movieData.success) {
                orderWithDetails.movieTitle = movieData.data.title
              }
              ...
              if (cinemaData.success) {
                orderWithDetails.cinemaName = cinemaData.data.name
              }
              ...
              if (hallData.success) {
                orderWithDetails.hallName = hallData.data.hallNumber
              }
            }
          }

          // 获取座位信息
          const orderSeatResponse = await fetch(`${API_BASE_URL}/order-seats/order/${order.id}`)
