...
const loadCinemas = async () => {
  try {
    ...
    if (data.success) cinemas.value = data.data
  } catch (error) {
...
const loadMovies = async () => {
  try {
    ...
    const data = await response.json()
    if (data.success) movies.value = data.data
  } catch (error) {
...
const loadHalls = async () => {
  try {
    ...
    const data = await response.json()
    if (data.success) halls.value = data.data
  } catch (error) {
...
const loadSchedules = async () => {
  try {
    let url = `${API_BASE_URL}/admin/schedules`
    const params = []
    ...
    const data = await response.json()
    if (data.success) schedules.value = data.data
  } catch (error) {
...
const loadOccupiedSlots = async () => {
  ...
  try {
    const response = await fetch(`${API_BASE_URL}/admin/schedule/occupied?hallId=${formData.value.hallId}&date=${formData.value.showDate}`)
    const data = await response.json()
    if (data.success) {
      occupiedSlots.value = data.data
    } else {
      occupiedSlots.value = []
    }
  } catch (error) {
...
const checkConflict = async () => {
  ...
  try {
    const response = await fetch(`${API_BASE_URL}/admin/schedule/conflict-check`, {
      method: 'POST',
...
const updateSchedule = async () => {
  ...
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/admin/schedules/${editingSchedule.value.id}`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify(scheduleData)
    })
