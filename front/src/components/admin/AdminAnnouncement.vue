...
const addAnnouncement = async () => {
  try {
    const data = await request.post('/admin/announcements', formData.value)
...
const updateAnnouncement = async () => {
  try {
    const data = await request.put(`/admin/announcements/${editingAnnouncement.value.id}`, {
      ...formData.value,
...
const toggleStatus = async (announcement) => {
  ...
  try {
    await request.put(`/admin/announcements/${announcement.id}/status`, { status: newStatus })
